...
exports.writeFileIfChanged = async (previousContentStr, logLevel) => {
  ...
  if (cardPositionsStr != previousContentStr) {
    ...
    console.log(
      apiFetcher
        ...
        .map(c => [c.name, c.cost, c.TopLeftY, c.TopLeftX])
    );
...
exports.writeFileWithDate = (filePrefix, content, logLevel) => {
